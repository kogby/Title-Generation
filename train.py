...
"""
# Code reference : https://github.com/huggingface/transformers/blob/main/examples/pytorch/summarization/run_summarization_no_trainer.py
...
def parse_args():
    ...
    if (
        ...
        if args.train_file is not None:
            extension = "json"  # args.train_file.split(".")[-1]
            assert extension in [
                "csv",
                "json",
            ], "`train_file` should be a csv or a json file."
        if args.validation_file is not None:
            extension = "json"  # args.validation_file.split(".")[-1]
            assert extension in [
                "csv",
                "json",
